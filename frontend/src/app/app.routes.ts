...
// Importación NECESARIA para el componente de Préstamos
...
    {
        path: '', // Se usa path vacío para que el componente hijo se cargue en la raíz lógica
        component: Layout, 
        // canActivate: [AuthGuard], // Descomentar para aplicar protección
        children: [
            // CRÍTICO: Redirige la ruta vacía *dentro del layout* al dashboard por defecto
...
            },
            ...
            // --- AÑADIDO: GESTIÓN DE PRÉSTAMOS (Ruta que faltaba) ---
            {
                path: 'prestamos', 
                component: PrestamosComponent, // El componente recién creado
